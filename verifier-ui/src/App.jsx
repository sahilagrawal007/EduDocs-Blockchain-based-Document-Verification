    ...
    <div className="app-root">
      ...
      {modalConfig && (
        <div className="custom-modal-overlay">
          <div className="custom-modal-card glass-panel animate-pop-in">
            <div className="modal-header">
              <Shield size={22} className="modal-icon" style={{ strokeWidth: 2.5 }} />
            ...
            <div className="modal-actions">
              {modalConfig.showConfirmBtn ? (
                <>
                  <button onClick={modalConfig.onCancel} className="btn-action-outline">
                    Cancel
                  </button>
                  <button onClick={modalConfig.onConfirm} className="btn-revoke" style={{ background: 'var(--primary)', color: '#ffffff', borderColor: 'var(--primary)', padding: '10px 20px', borderRadius: '12px' }}>
                    Confirm
                  </button>
                </>
              ) : (
                <button onClick={modalConfig.onConfirm} className="btn-action-outline" style={{ borderColor: 'var(--primary)', color: 'var(--primary)', background: 'rgba(79, 70, 229, 0.05)', padding: '10px 20px', borderRadius: '12px' }}>
                  Acknowledge
                </button>
              )}
            </div>
